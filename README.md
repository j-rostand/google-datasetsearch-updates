...
Si [un commentaire sur le blog de Google](https://support.google.com/webmasters/thread/8816828?hl=en&msgid=9515101) indiquait le 7 septembre 2019 que la requête automatisée sur Google Dataset Search était contraire aux conditions de service de l'entreprise, cette restriction semble être levée par les nouvelles [conditions d'utilisation du 31 mars 2020](https://policies.google.com/terms?hl=en) en [l'absence de règles et conditions supplémentaires spécifiques à propos de ce service](https://policies.google.com/terms/service-specific?hl=en). Quoi qu'il en soit, les utilisateurs de ce programme restent les seuls responsables de son emploi.
